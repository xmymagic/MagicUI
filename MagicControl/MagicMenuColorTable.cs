...
namespace MagicUI.MagicControl
{
    public class MagicMenuColorTable : ProfessionalColorTable
    {
        //Fields
        ...
        //Constructor
        public MagicMenuColorTable(bool isMainMenu, Color primaryColor)
        {
            if (isMainMenu)
            {
        ...
        public class MenuRenderer : ToolStripProfessionalRenderer
        {
            ...
            public MenuRenderer(bool isMainMenu, Color primaryColor, Color textColor)
                : base(new MagicMenuColorTable(isMainMenu, primaryColor))
            {
